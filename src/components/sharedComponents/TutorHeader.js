    ...
    <div className="p-3 bg-success border-bottom">
      <Nav className="d-flex justify-content-between align-items-center">
        <div className="d-flex justify-content-around align-items-center col-md-5 col-xl-6">
          ...
          <Nav.Item>
            <Link className='fs-5 text-white' to="/tutor-dashboard">Dashboard</Link>
          </Nav.Item>
          <Nav.Item>
            <Link className='fs-5 text-white' to="/find-quran-students">Find Students</Link>
          </Nav.Item>
          <Nav.Item>
            <Link className='fs-5 text-white' to="/calls-history">Billing</Link>
          </Nav.Item>
          <Nav.Item>
